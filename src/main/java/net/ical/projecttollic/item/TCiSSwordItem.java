...
public class TCiSSwordItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:tcissword")
	public static final Item block = null;
	public TCiSSwordItem(PrjectllicElements instance) {
		super(instance, 13);
	}

...
public class HHoSProSwordItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:hhosprosword")
	public static final Item block = null;
	public HHoSProSwordItem(PrjectllicElements instance) {
		super(instance, 5);
	}

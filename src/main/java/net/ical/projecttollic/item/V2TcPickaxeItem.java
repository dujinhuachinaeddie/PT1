...
public class V2TcPickaxeItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:v2tcpickaxe")
	public static final Item block = null;
	public V2TcPickaxeItem(PrjectllicElements instance) {
		super(instance, 19);
	}

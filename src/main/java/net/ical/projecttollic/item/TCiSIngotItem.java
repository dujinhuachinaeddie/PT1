...
public class TCiSIngotItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:tcisingot")
	public static final Item block = null;
	public TCiSIngotItem(PrjectllicElements instance) {
		super(instance, 10);
	}

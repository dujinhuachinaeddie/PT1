...
public class V2TcGemItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:v2tcgem")
	public static final Item block = null;
	public V2TcGemItem(PrjectllicElements instance) {
		super(instance, 18);
	}

...
public class TCiSPickaxeItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:tcispickaxe")
	public static final Item block = null;
	public TCiSPickaxeItem(PrjectllicElements instance) {
		super(instance, 11);
	}

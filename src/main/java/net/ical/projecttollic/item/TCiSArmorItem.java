...
public class TCiSArmorItem extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:tcisarmorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("projecttollic:tcisarmorbody")
	public static final Item body = null;
	@ObjectHolder("projecttollic:tcisarmorlegs")
	public static final Item legs = null;
	@ObjectHolder("projecttollic:tcisarmorboots")
	public static final Item boots = null;
	public TCiSArmorItem(PrjectllicElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(Pr0jec7stuffItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "projecttollic:textures/models/armor/tcis_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("tcisarmorhelmet"));
		...
		}.setRegistryName("tcisarmorboots"));
	}
}

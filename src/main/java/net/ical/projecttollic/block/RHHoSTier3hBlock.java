...
public class RHHoSTier3hBlock extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:rhhostier3h")
	public static final Block block = null;
	public RHHoSTier3hBlock(PrjectllicElements instance) {
		super(instance, 69);
	}

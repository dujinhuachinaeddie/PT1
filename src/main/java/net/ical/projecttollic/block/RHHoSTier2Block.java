...
public class RHHoSTier2Block extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:rhhostier2")
	public static final Block block = null;
	public RHHoSTier2Block(PrjectllicElements instance) {
		super(instance, 67);
	}

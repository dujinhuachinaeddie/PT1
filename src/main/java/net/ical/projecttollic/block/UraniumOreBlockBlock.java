...
public class UraniumOreBlockBlock extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:uraniumoreblock")
	public static final Block block = null;
	public UraniumOreBlockBlock(PrjectllicElements instance) {
		super(instance, 95);
	}

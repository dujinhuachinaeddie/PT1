...
public class HHoSProOreBlockBlock extends PrjectllicElements.ModElement {
	@ObjectHolder("projecttollic:hhosprooreblock")
	public static final Block block = null;
	public HHoSProOreBlockBlock(PrjectllicElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hhosprooreblock");
		}
